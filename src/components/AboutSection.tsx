...
const AboutSection = () => {
  return (
    <section id="about" className="grid grid-cols-12 gap-4 md:gap-8 px-6 md:px-12 lg:px-20 py-[15vh] border-t border-border">
      <motion.div
      ...
      >
        ...
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif italic tracking-tighter-custom mb-8">
          Une_Peulh<br />Photographe
        </h2>
        <p className="text-base leading-pretty text-muted-foreground max-w-[55ch] mb-6">
          Formée à la photographie au sein de Eyelitestudio, j'ai développé une maîtrise technique et artistique qui me permet de sublimer mes sujets sous différents angles : portrait, studio, événements ou encore reportages visuels.
        </p>
        <p className="text-base leading-pretty text-muted-foreground max-w-[55ch]">
          Titulaire d'un Master en Audit, Contrôle et Comptabilité, je porte une rigueur et une organisation précieuses dans la gestion de mes projets et collaborations.
        </p>
      </motion.div>
    </section>
  );
